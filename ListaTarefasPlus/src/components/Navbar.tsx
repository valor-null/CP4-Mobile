...
export default function Navbar({ value, onChange, style }: Props) {
    ...
    return (
        ...
        <View style={[styles.bar, { backgroundColor: P.card }]}>
            ...
            >
            <Ionicons name={value === 'tasks' ? 'list' : 'list-outline'} size={18} color={value === 'tasks' ? P.bg : P.primary} />
            <Text style={[styles.lbl, { color: value === 'tasks' ? P.bg : P.primary }]}>Tarefas</Text>
            </TouchableOpacity>
            ...
            >
            <Ionicons name={value === 'quotes' ? 'chatbubbles' : 'chatbubbles-outline'} size={18} color={value === 'quotes' ? P.bg : P.primary} />
            <Text style={[styles.lbl, { color: value === 'quotes' ? P.bg : P.primary }]}>Frases</Text>
            </TouchableOpacity>
            ...
            >
            <Ionicons name={value === 'profile' ? 'person-circle' : 'person-circle-outline'} size={20} color={value === 'profile' ? P.bg : P.primary} />
            <Text style={[styles.lbl, { color: value === 'profile' ? P.bg : P.primary }]}>Perfil</Text>
            </TouchableOpacity>
        </View>
        </View>
    )
